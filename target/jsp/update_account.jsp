            ...
            <dl>
                ...
                <dd>
                    <div class="fieldWrapper">
                        ...
                        <input name="oldPassword" id="oldPassword" type="password" required="required">
                    </div>
                <dd>
                    <div class="fieldWrapper">
                        <label for="confirmOldPassword"><span id="label">Confirm Password:</span></label><br />
                        <input name="confirmOldPassword" id="confirmOldPassword" type="password" required="required"><br />
