...
public class DataScope {
    ...
    public DataScope(boolean isScopeTotal) {
        user_dataScope = new User_DataScope();
        user_dataScope.loadPreference = isScopeTotal;
        user_dataScope.loadTrips = isScopeTotal;
        user_dataScope.trip_dataScope.loadPreference = isScopeTotal;
        user_dataScope.trip_dataScope.loadAvailableTimes = isScopeTotal;
        user_dataScope.trip_dataScope.loadItinerary = isScopeTotal;
        user_dataScope.trip_dataScope.loadLodging = isScopeTotal;
        user_dataScope.trip_dataScope.itinerary_dataScope.loadTimeSlots = isScopeTotal;
    }
